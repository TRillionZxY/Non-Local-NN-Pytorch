...
parser.add_argument('--nl', '-n', action='store_true',
...
trainset = torchvision.datasets.CIFAR10(
    root='/mnt/ssd/zxy', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=256, shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR10(
    root='/mnt/ssd/zxy', train=False, download=True, transform=transform_test)
